...
class PerfilPersonalScreen2 extends StatefulWidget {
  final PersonalModel
  personalModel; // Renombrado de personalRating para mayor claridad
  final double? promedioCalificacion; // Nuevo campo para el promedio

  const PerfilPersonalScreen2({
    super.key,
    required this.personalModel, // Ahora es el modelo principal
    this.promedioCalificacion, // Hazlo opcional si no siempre estará
  });

  @override
  State<PerfilPersonalScreen2> createState() => _PerfilPersonalScreen2State();
}

class _PerfilPersonalScreen2State extends State<PerfilPersonalScreen2> {
  @override
                ...
                children: [
                  Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.network(
                        'https://helfer.flatzi.com/img/personal/${widget.personalModel.foto}',
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Text(
                              '${widget.personalModel.nombre} ${widget.personalModel.apellido}',
                          ...
                          children: [
                            Row(
                              children: List.generate(5, (i) {
                                return Icon(
                                  i < widget.promedioCalificacion!.round()
                                      ? Icons.star
                                      : Icons.star_border,
                                  size: 20,
                                  color: Colors.amber,
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        _buildStatItem(
                          Icons.star,
                          widget.promedioCalificacion!.toStringAsFixed(1),
                        ),
                        const Spacer(),
                        ElevatedButton.icon(
                          onPressed: () {
